...
namespace StructureUBL.EstandarUbl
{
    public class DebitNote : IXmlSerializable, IEstructuraXml
    {
        ...
        public List<DocumentLine>                       DebitNoteLines { get; set; }
        ...
        public DebitNote()
        {
            ...
            DebitNoteLines                  =   new List<DocumentLine>();
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            #region DocumentCurrencyCode Nro Oasis 13
            ...
            #endregion DocumentCurrencyCode Nro Oasis 13

            #region DiscrepancyResponse Nro Oasis 22
            ...
            #endregion DiscrepancyResponse Nro Oasis 22

            #region BillingReference Nro Oasis 24
            ...
            #endregion BillingReference Nro Oasis 24

            #region DespatchDocumentReference Nro Oasis 25
            ...
            //    writer.WriteEndElement();
            //}
            #endregion DespatchDocumentReference Nro Oasis 25

            #region AdditionalDocumentReference Nro Oasis 29
            ...
            //    writer.WriteEndElement();
            //}
            #endregion AdditionalDocumentReference Nro Oasis 29

            #region Signature Nro Oasis 30
            ...
            #endregion Signature Nro Oasis 30

            #region AccountingSupplierParty Nro Oasis 31
            ...
            writer.WriteEndElement();
            #endregion AccountingSupplierParty Nro Oasis 31

            #region AccountingCustomerParty Nro Oasis 32
            ...
            writer.WriteEndElement();
            #endregion AccountingCustomerParty Nro Oasis 32

            #region TaxTotal Nro Oasis 47
            ...
            #endregion TaxTotal Nro Oasis 47

            #region RequestedMonetaryTotal Nro Oasis 48
            writer.WriteStartElement("cac:RequestedMonetaryTotal"); // [1..1] 
            {
                ...
                {   // Código de tipo de moneda del total valor de venta
                    writer.WriteAttributeString("currencyID", RequestedMonetaryTotal.LineExtensionAmount.CurrencyId.ToString());
                    writer.WriteValue(RequestedMonetaryTotal.LineExtensionAmount.Value.ToString()); // Total valor de venta
                }
                writer.WriteEndElement();

                if (RequestedMonetaryTotal.TaxInclusiveAmount.Value != 0)
                {
                    ...
                    {   // Código de tipo de moneda del total precio de venta (incluye impuestos)
                        writer.WriteAttributeString("currencyID", RequestedMonetaryTotal.TaxInclusiveAmount.CurrencyId.ToString());
                        writer.WriteValue(RequestedMonetaryTotal.TaxInclusiveAmount.Value.ToString()); // Total precio de venta (incluye impuestos)
                    }
                    writer.WriteEndElement();
                }

                if (RequestedMonetaryTotal.AllowanceTotalAmount.Value != 0)
                {
                    ...
                    {   // Código de tipo de moneda del monto total de descuentos globales del comprobante
                        writer.WriteAttributeString("currencyID", RequestedMonetaryTotal.AllowanceTotalAmount.CurrencyId.ToString());
                        writer.WriteValue(RequestedMonetaryTotal.AllowanceTotalAmount.Value.ToString()); // Monto total de descuentos del comprobante
                    }
                    writer.WriteEndElement();
                }

                if (RequestedMonetaryTotal.ChargeTotalAmount.Value != 0)
                {
                    ...
                    {   // Código de tipo de moneda del monto total de otros cargos del comprobante
                        writer.WriteAttributeString("currencyID", RequestedMonetaryTotal.ChargeTotalAmount.CurrencyId.ToString());
                        writer.WriteValue(RequestedMonetaryTotal.ChargeTotalAmount.Value.ToString()); // Monto total de otros cargos del comprobante
                    }
                    writer.WriteEndElement();
                }

                if (RequestedMonetaryTotal.PrepaidAmount.Value != 0)
                {
                    ...
                    {   // Código de tipo de moneda del monto total de anticipos del comprobante
                        writer.WriteAttributeString("currencyID", RequestedMonetaryTotal.PrepaidAmount.CurrencyId.ToString());
                        writer.WriteValue(RequestedMonetaryTotal.PrepaidAmount.Value.ToString()); // Monto total de anticipos del comprobante
                    }
                    writer.WriteEndElement();
                }
                ...
                {   // Código tipo de moneda del importe total de la venta, cesión en uso o del servicio prestado
                    writer.WriteAttributeString("currencyID", RequestedMonetaryTotal.PayableAmount.CurrencyId.ToString());
                    writer.WriteValue(RequestedMonetaryTotal.PayableAmount.Value.ToString()); // Importe total de la venta, cesión en uso o del servicio prestado
                }
                writer.WriteEndElement();

                if (!string.IsNullOrEmpty(RequestedMonetaryTotal.PayableRoundingAmount.Value.ToString()) && RequestedMonetaryTotal.PayableRoundingAmount.Value != 0)
                {
                    writer.WriteStartElement("cbc:PayableRoundingAmount");  // New
                    {
                        writer.WriteAttributeString("currencyID", RequestedMonetaryTotal.PayableRoundingAmount.CurrencyId);
                        writer.WriteValue(RequestedMonetaryTotal.PayableRoundingAmount.Value);
                    }
                    writer.WriteEndElement();
                }
            }
            writer.WriteEndElement();
            #endregion LegalMonetaryTotal Nro Oasis 48

            #region DebitNoteLine Nro Oasis 49
            foreach (var debitNoteLine in DebitNoteLines) // Sin validación porque siempre debe haber al menos uno
            {
                writer.WriteStartElement("cac:DebitNoteLine"); // [1..*] InvoiceLine
                {
                    #region Atributos propios de DebitNoteLine 
                    writer.WriteElementString("cbc:ID", debitNoteLine.IdDocumentLine.ToString()); // Número de orden del Ítem

                    #region DebitedQuantity
                    if (!string.IsNullOrEmpty(debitNoteLine.DebitedQuantity.Value.ToString()))
                    {
                        writer.WriteStartElement("cbc:DebitedQuantity"); // [0..1] Cantidad de unidades del ítem
                        {
                            writer.WriteAttributeString("unitCode", debitNoteLine.DebitedQuantity.UnitCode); // Código de unidad de medida del ítem
                            writer.WriteAttributeString("unitCodeListID", debitNoteLine.DebitedQuantity.UnitCodeListID);
                            writer.WriteAttributeString("unitCodeListAgencyName", debitNoteLine.DebitedQuantity.UnitCodeListAgencyName);
                            writer.WriteValue(debitNoteLine.DebitedQuantity.Value.ToString());
                        }
                        writer.WriteEndElement();
                    }
                    ...
                    {   // Código de tipo de moneda del valor de venta del ítem
                        writer.WriteAttributeString("currencyID", debitNoteLine.LineExtensionAmount.CurrencyId.ToString());
                        writer.WriteValue(debitNoteLine.LineExtensionAmount.Value.ToString());
                    }
                    writer.WriteEndElement();
                    ...
                    #endregion Atributos propios de DebitNoteLine

                    #region debitNoteLine > PricingReference
                    if (debitNoteLine.PricingReference.AlternativeConditionPrices.Count > 0)
                    {
                        writer.WriteStartElement("cac:PricingReference"); //  [0..1] PricingReference
                        {
                            ...
                            if (debitNoteLine.PricingReference.AlternativeConditionPrices.Count > 0)
                            {
                                foreach (var alternativeConditionPrice in debitNoteLine.PricingReference.AlternativeConditionPrices)
                                {
                    ...
                    #endregion debitNoteLine > PricingReference
                    #region debitNoteLine > TaxTotal
                    if (debitNoteLine.TaxTotals.Count > 0)
                    {
                        foreach (var taxTotal in debitNoteLine.TaxTotals)
                        {
                    ...
                    #endregion debitNoteLine > TaxTotal

                    #region debitNoteLine > Item
                    writer.WriteStartElement("cac:Item");   //  [1..1] 
                    {
                        #region Item > Description
                        if (debitNoteLine.Item.Descriptions.Count > 0)
                        {   // Descripción(es) detallada del servicio prestado, bien vendido o cedido en uso, indicando las características.
                            foreach (var description in debitNoteLine.Item.Descriptions)
                        ...
                        if (!string.IsNullOrEmpty(debitNoteLine.Item.SellersItemIdentification.Id.ToString()))
                        {
                            writer.WriteStartElement("cac:SellersItemIdentification"); // [0..1] 
                            {
                                writer.WriteElementString("cbc:ID", debitNoteLine.Item.SellersItemIdentification.Id.ToString()); // [1..1] | Código de producto del ítem
                            }
                            writer.WriteEndElement();
                        }
                        ...
                        if (!string.IsNullOrEmpty(debitNoteLine.Item.CommodityClassification.ItemClassificationCode.Value.ToString()))
                        {   // No es obligatorio
                            ...
                            {   // Código de producto (SUNAT)
                                ...
                                {
                                    writer.WriteAttributeString("listID", debitNoteLine.Item.CommodityClassification.ItemClassificationCode.ListID.ToString());
                                    writer.WriteAttributeString("listAgencyName", debitNoteLine.Item.CommodityClassification.ItemClassificationCode.ListAgencyName.ToString());
                                    writer.WriteAttributeString("listName", debitNoteLine.Item.CommodityClassification.ItemClassificationCode.ListName.ToString());
                                    writer.WriteValue(debitNoteLine.Item.CommodityClassification.ItemClassificationCode.Value.ToString());
                                }
                                writer.WriteEndElement();
                            }
                            writer.WriteEndElement();
                        ...
                        if (debitNoteLine.Item.AdditionalItemProperties.Count > 0)
                        {
                            foreach (var additionalItemProperty in debitNoteLine.Item.AdditionalItemProperties)
                            {
                        ...
                        #endregion debitNoteLine > Item
                    }
                    writer.WriteEndElement();

                    #region DebitNoteLine > Price
                    if (!string.IsNullOrEmpty(debitNoteLine.Price.PriceAmount.Value.ToString()))
                    {   // Valor unitario del ítem
                        ...
                        {    // Código de tipo de moneda del valor unitario del ítem
                            writer.WriteStartElement("cbc:PriceAmount");
                            {
                                ...
                                writer.WriteValue(debitNoteLine.Price.PriceAmount.Value.ToString());
                            }
                            writer.WriteEndElement();
                        }
                        writer.WriteEndElement();
                    }
                    #endregion debitNoteLine > Price
                }
                writer.WriteEndElement(); // end InvoiceLine
            }
            #endregion debitNoteLine Nro Oasis 49
        }
    }
}
